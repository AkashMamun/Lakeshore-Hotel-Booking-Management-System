...
<body>
                    ...
                    <div class="collapse navbar-collapse navbar-right" style="margin-top:20px;" id="bs-example-navbar-collapse-1">
                        <nav class="menu menu--iris">
                            <ul class="nav navbar-nav menu__list" id="myDiv">
                                ...
                                <li class="menu__item menu__item--current active"><a href="#gallery" class="menu__link">Gallery</a></li>
    ...
    <section class="portfolio-w3ls" id="gallery">
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/l1.png" class="swipebox"><img src="images/l1.png" class="img-responsive" style="height:236px; width:350px" alt="/">
                <div class="textbox">
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/logo.png" class="swipebox"><img src="images/logo.png" class="img-responsive" style="height:237px;" alt="/">
                <div class="textbox">
                    <h4>LAKESHORE HOTEL</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/l2.png" class="swipebox"><img src="images/l2.png" class="img-responsive" style="height:236px; width:350px" alt="/">
                <div class="textbox">
                    <h4>LAKESHORE HOTEL</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
        ...
        <div class="col-md-3 gallery-grid gallery1">
            <a href="images/l3.png" class="swipebox"><img src="images/l3.png" class="img-responsive" style="height:236px; width:350px" alt="/">
                <div class="textbox">
                    <h4>LAKESHORE HOTEL</h4>
                    <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
                </div>
    ...
    <!-- /contact -->
    <div class="copy">
        <p>© LAKESHORE HOTEL IN RANGAMATI. All Rights Reserved | Design by <a href="index.php"> 2022 LAKESHORE HOTEL IN RANGAMATI</a> </p>
    </div>
    <!--/footer -->
    <!-- js -->

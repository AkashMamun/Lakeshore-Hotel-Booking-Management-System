...
<head>
    <title>Lakeshore Hotel In Ranagamti</title>
    <!-- for-mobile-apps -->
...
--->
                    ...
                    <div class="collapse navbar-collapse navbar-right" style="margin-top:20px;" id="bs-example-navbar-collapse-1">
                        <nav class="menu menu--iris">
                            <ul class="nav navbar-nav menu__list" id="myDiv">
                                ...
                                <li class="menu__item menu__item--current active"><a href="./team.php" class="menu__link">Team</a></li>
        ...
        <div class="container">
            ...
            <div id="horizontalTab">
                <ul class="resp-tabs-list">
                    <li>
                        <img src="images/mam/mam9.jpg" alt="" class="img-responsive" style="height:120px;width:120px;" />
                    </li>
                    <li>
                        <img src="images/v5.jpg" alt=" " class="img-responsive" style="height:120px;width:120px;" />
                    </li>
                    <li>
                        <img src="images/v22.jpg" alt=" " class="img-responsive" style="height:120px;width:120px;" />
                    </li>
                    <li>
                        <img src="images/urmi.jpg" alt=" " class="img-responsive" style="height:120px;width:120px;" />
                    </li>
                </ul>
                ...
                <div class="resp-tabs-container">
                    <div class="tab1">
                        ...
                        <div class="col-md-6 team-Info-agileits">
                            <h4>Mr. Nahidul Islam</h4>
                            <span>Founder</span>
                            <p>Mr. Nahidul Islam is our honourble Supervisor & Founder of this site.She helps us most of time and suggestion us to make this site user friendly. We work together lot of time to make it good simple & beautiful.</p>
                    ...
                    <div class="tab2">
                        ...
                        <div class="col-md-6 team-Info-agileits">
                            ...
                            <p>Akash Mamun Play an important role for the post of CEO.LLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ..</p>
                            <div class="social-bnr-agileits footer-icons-agileinfo">
                                <ul class="social-icons3">
                                    <li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
                                    <li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
    ...
    <!-- /contact -->
    <div class="copy">
        <p>© LAKESHORE HOTEL IN RANGAMATI. All Rights Reserved | Design by <a href="index.php"> 2022 LAKESHORE HOTEL</a> </p>
    </div>
    <!--/footer -->
    <!-- js -->

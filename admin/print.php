...
<body>
	...
	$type_of_room = 0;
	if ($troom == "LakeView Room") {
		$type_of_room = 9000;
	} else if ($troom == "Family Room") {
		$type_of_room = 7000;
	} else if ($troom == "HoneyMoon Room") {
		$type_of_room = 5000;
	...
	?>
	<header>
		<h1>Lakeshore Hotel Invoice</h1>
		<address>
			<p>Lakeshore Hotel In Rangamati</p>
			<p>DC Banglow Road,<br>Rangamati Sadar,Chattogram<br>Bangladesh.</p>
			<p>(+880) 1521 30 85 12</p>
		</address>
	...
	<aside>
		...
		<div>
			<p style="text-align:center;">Email :- info@polwelpark.com || Web :- www.polwelpark.com || Phone :- +880 1521308512 </p>
		</div>
	</aside>
</body>

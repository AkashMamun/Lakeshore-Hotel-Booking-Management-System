...
<head>
	<title>lakeshore Hotel In Rangamati</title>
	<!-- for-mobile-apps -->
			...
			<div class="container b">
				<nav class="navbar navbar-default">
					<div class="navbar-header navbar-left">
						...
						<h1>Lakeshore Hotel In Rangamati</h1>
					...
					<div class="collapse navbar-collapse navbar-right" style="margin-top:20px;" id="bs-example-navbar-collapse-1">
						<nav class="menu menu--iris">
							<ul class="nav navbar-nav menu__list" id="myDiv">
								<li class="menu__item menu__item--current active"><a href="" class="menu__link">Home</a></li>

								<li class="menu__item"><a href="./about.php" target="__blank" class=" menu__link">About</a></li>

								<li class="menu__item"><a href="./team.php" target="__blank" class=" menu__link">Team</a></li>

								<li class="menu__item"><a href="./gallery.php" target="__blank" class=" menu__link">Gallery</a></li>

								<li class="menu__item"><a href="./room.php" class="menu__link" target="__blank">Rooms</a></li>

								<li class="menu__item"><a href="./contact.php" target="__blank" class=" menu__link ">Contact Us</a></li>
							</ul>
						</nav>
					</div>
				</nav>
	...
	<div class="plans-section" id="rooms">
		<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">
				LAKESHORE HOTEL IN RANGAMATI</h3>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">LAKESHORE HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Address :</strong> DC Banglaow Road, Rangamati, Bangladesh</p>
